...
RSpec.describe "erb_lint integration" do # rubocop:disable RSpec/DescribeClass
  ...
  it "flags images in an admin row partial" do
    offenses = lint("app/views/admin/pages/_page.html+row.erb", <<~ERB)
      <% row.cell :image do %>
